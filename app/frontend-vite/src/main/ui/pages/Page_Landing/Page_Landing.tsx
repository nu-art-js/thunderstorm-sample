...
export class Page_Landing
	...
	constructor(p: any) {
		super(p, 'Thunderstorm Template Page (Vite)');
	}
	...
	private renderReactSVG = () => {
		return <svg height="2500" viewBox="175.7 78 490.6 436.9" width="2194" xmlns="http://www.w3.org/2000/svg">
			<g fill="#61dafb">
				<path
